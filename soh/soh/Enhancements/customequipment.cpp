...
void UpdatePatchCustomEquipmentDlists() {
            ...
            ApplyPatchRequests(
                {
                    ...
                    { gLinkChildHylianShieldAndSheathNearDL, gCustomKokiriSwordSheathDL,
                    ...
                    { gLinkAdultSheathNearDL, gCustomKokiriSwordSheathDL, "customSheath1", "customSheath2", NULL,
                      NULL },
            ...
            ApplyPatchRequests(
                {
                    ...
                    { gLinkChildHylianShieldAndSheathNearDL, gCustomMasterSwordSheathDL,
                      "customChildHylianShieldSheath1", "customChildHylianShieldSheath2",
                      "customChildHylianShieldSheath3", gCustomHylianShieldOnChildBackDL },
                    ...
                    { gLinkChildHylianShieldAndSheathNearDL, gCustomMasterSwordSheathDL,
                      "customChildHylianShieldSheath1", "customChildHylianShieldSheath2",
                      "customChildHylianShieldSheath3", gCustomHylianShieldOnChildBackDL },
                    { gLinkAdultSheathNearDL, gCustomMasterSwordSheathDL, "customSheath1", "customSheath2", NULL,
                      NULL },
                    { gLinkAdultHylianShieldSwordAndSheathNearDL, gCustomMasterSwordInSheathDL,
                      "customHylianShieldSword1", "customHylianShieldSword2", "customHylianShieldSword3",
                      gCustomHylianShieldOnBackDL },
                ...
                ApplyPatchRequests(
                    {
                        { gLinkChildDekuShieldWithMatrixDL, gCustomLongswordSheathDL, "customDekuShieldBack1",
                          "customDekuShieldBack2", "customDekuShieldBack3", gCustomDekuShieldOnBackDL },
                        { gLinkChildHylianShieldAndSheathNearDL, gCustomLongswordSheathDL,
                          "customChildHylianShieldSheath1", "customChildHylianShieldSheath2",
                          "customChildHylianShieldSheath3", gCustomHylianShieldOnChildBackDL },
                        ...
                        { gLinkChildSheathNearDL, gCustomLongswordSheathDL, "customKokiriSheath1",
                        ...
                        { gLinkAdultSheathNearDL, gCustomLongswordSheathDL, "customSheath1", "customSheath2", NULL,
                          NULL },
                ...
                ApplyPatchRequests(
                    {
                        ...
                        { gLinkChildSheathNearDL, gCustomBreakableLongswordSheathDL, "customKokiriSheath1",
                          "customKokiriSheath2", NULL, NULL },
                        { gLinkChildSwordAndSheathNearDL, gCustomBreakableLongswordInSheathDL,
                          "customKokiriSwordSheath1", "customKokiriSwordSheath2", NULL, NULL },
                        ...
                        { gLinkChildDekuShieldWithMatrixDL, gCustomBreakableLongswordSheathDL, "customDekuShieldBack1",
                          "customDekuShieldBack2", "customDekuShieldBack2", gCustomDekuShieldOnBackDL },
                        { gLinkChildDekuShieldWithMatrixDL, gCustomBreakableLongswordInSheathDL,
                          "customDekuShieldBack1", "customDekuShieldBack2", "customDekuShieldBack2",
                          gCustomDekuShieldOnBackDL },
            ...
            ApplyPatchRequests(
                {
                    { gLinkChildDekuShieldWithMatrixDL, gCustomBrokenLongswordSheathDL, "customDekuShieldBack1",
                      "customDekuShieldBack2", "customDekuShieldBack3", gCustomDekuShieldOnBackDL },
                    { gLinkChildHylianShieldAndSheathNearDL, gCustomBrokenLongswordSheathDL,
                      "customChildHylianShieldSheath1", "customChildHylianShieldSheath2",
                      "customChildHylianShieldSheath3", gCustomHylianShieldOnChildBackDL },
                    ...
                    { gLinkChildSwordAndSheathNearDL, gCustomBrokenLongswordInSheathDL, "customKokiriSwordSheath1",
                      "customKokiriSwordSheath2", NULL, NULL },
                    { gLinkChildDekuShieldSwordAndSheathNearDL, gCustomBrokenLongswordSheathDL,
                      "customDekuShieldSword1", "customDekuShieldSword2", "customDekuShieldSword3",
                      gCustomDekuShieldOnBackDL },
                    { gLinkChildDekuShieldWithMatrixDL, gCustomBrokenLongswordSheathDL, "customDekuShieldBack1",
                      "customDekuShieldBack2", "customDekuShieldBack2", gCustomDekuShieldOnBackDL },
                    ...
                    { gLinkAdultHylianShieldSwordAndSheathNearDL, gCustomBrokenLongswordInSheathDL,
                      "customHylianShieldSword1", "customHylianShieldSword2", "customHylianShieldSword3",
                      gCustomHylianShieldOnBackDL },
                    { gLinkAdultHylianShieldAndSheathNearDL, gCustomBrokenLongswordSheathDL,
                      "customHylianShieldSheath1", "customHylianShieldSheath2", "customHylianShieldSheath3",
                      gCustomHylianShieldOnBackDL },
                    { gLinkAdultMirrorShieldSwordAndSheathNearDL, gCustomBrokenLongswordInSheathDL,
                      "customMirrorShieldSword1", "customMirrorShieldSword2", "customMirrorShieldSword3",
                      gCustomMirrorShieldOnBackDL },
                    { gLinkAdultMirrorShieldAndSheathNearDL, gCustomBrokenLongswordSheathDL,
                      "customMirrorShieldSheath1", "customMirrorShieldSheath2", "customMirrorShieldSheath3",
                      gCustomMirrorShieldOnBackDL },
    ...
    ApplyPatchRequests(
        {
            { gLinkAdultLeftHandHoldingMasterSwordNearDL, gCustomMasterSwordDL, "customMasterSword1",
        ...
        ApplyPatchRequests(
            {
                ...
                { gLinkAdultRightHandHoldingHookshotFarDL, gCustomHookshotDL, "customHookshotFPS1",
        ...
        ApplyPatchRequests(
            {
                { gLinkAdultRightHandHoldingHookshotNearDL, gCustomLongshotDL, "customHookshot1", "customHookshot2",
                  "customHookshot3", gLinkAdultRightHandClosedNearDL },
                { gLinkAdultRightHandHoldingHookshotFarDL, gCustomLongshotDL, "customHookshotFPS1",
                  "customHookshotFPS2", "customHookshotFPS3", gCustomAdultFPSHandDL },
            },
            useAltAssets);
    }
    ...
    if (LINK_IS_CHILD && equipmentAlwaysVisible) {
        ApplyPatchRequests(
            {
                { gCustomAdultFPSHandDL, gCustomChildFPSHandDL, "patchChildFPSHand1", "patchChildFPSHand2", NULL,
                  NULL },
    ...
    if (LINK_IS_ADULT && equipmentAlwaysVisible) {
        ApplyPatchRequests(
            {
                { gCustomChildFPSHandDL, gCustomAdultFPSHandDL, "patchAdultFPSHand1", "patchAdultFPSHand2", NULL,
                  NULL },
                { gLinkChildRightHandClosedNearDL, gLinkAdultRightHandClosedNearDL, "customAdultRightHand1",
                  "customAdultRightHand2", NULL, NULL },
                { gLinkChildLeftFistNearDL, gLinkAdultLeftHandClosedNearDL, "customAdultLeftHand1",
