...
static void ApplySwordlessChildPatches() {
    ...
    PatchOrUnpatch(gLinkChildHylianShieldSwordAndSheathNearDL, gCustomHylianShieldOnChildBackDL,
                   "customChildHylianShieldOnly1", "customChildHylianShieldOnly2", nullptr, nullptr);
    PatchOrUnpatch(gLinkAdultMirrorShieldSwordAndSheathNearDL, gCustomMirrorShieldOnBackDL, "customAdultMirrorOnly1",
...
static void ApplySwordlessAdultPatches() {
    PatchOrUnpatch(gLinkAdultHylianShieldSwordAndSheathNearDL, gCustomHylianShieldOnBackDL, "customAdultShieldOnly1",
                   "customAdultShieldOnly2", nullptr, nullptr);
    PatchOrUnpatch(gLinkAdultMirrorShieldSwordAndSheathNearDL, gCustomMirrorShieldOnBackDL, "customAdultMirrorOnly1",
                   "customAdultMirrorOnly2", nullptr, nullptr);
    PatchOrUnpatch(gLinkChildDekuShieldSwordAndSheathNearDL, gCustomDekuShieldOnBackDL, "customDekuShieldSword1",
...
static void ApplyKokiriSwordPatches() {
    ...
    PatchOrUnpatch(gLinkChildHylianShieldAndSheathNearDL, gCustomKokiriSwordSheathDL, "customChildHylianShieldSheath1",
                   "customChildHylianShieldSheath2", "customChildHylianShieldSheath3",
                   gCustomHylianShieldOnChildBackDL);
    PatchOrUnpatch(gLinkAdultSheathNearDL, gCustomKokiriSwordSheathDL, "customSheath1", "customSheath2", nullptr,
                   nullptr);
    PatchOrUnpatch(gLinkAdultHylianShieldSwordAndSheathNearDL, gCustomKokiriSwordInSheathDL, "customHylianShieldSword1",
    ...
    PatchOrUnpatch(gLinkAdultMirrorShieldSwordAndSheathNearDL, gCustomKokiriSwordInSheathDL, "customMirrorShieldSword1",
...
static void ApplyMasterSwordPatches() {
    ...
    PatchOrUnpatch(gLinkChildHylianShieldAndSheathNearDL, gCustomMasterSwordSheathDL, "customChildHylianShieldSheath1",
                   "customChildHylianShieldSheath2", "customChildHylianShieldSheath3",
                   gCustomHylianShieldOnChildBackDL);
    ...
    PatchOrUnpatch(gLinkChildHylianShieldSwordAndSheathNearDL, gCustomMasterSwordInSheathDL,
                   "customChildHylianShieldSword1", "customChildHylianShieldSword2", "customChildHylianShieldSword3",
                   gCustomHylianShieldOnChildBackDL);
    PatchOrUnpatch(gLinkAdultSheathNearDL, gCustomMasterSwordSheathDL, "customSheath1", "customSheath2", nullptr,
                   nullptr);
    PatchOrUnpatch(gLinkAdultMasterSwordAndSheathNearDL, gCustomMasterSwordInSheathDL, "customMasterSwordSheath1",
                   "customMasterSwordSheath2", nullptr, nullptr);
    PatchOrUnpatch(gLinkAdultHylianShieldSwordAndSheathNearDL, gCustomMasterSwordInSheathDL, "customHylianShieldSword1",
                   "customHylianShieldSword2", "customHylianShieldSword3", gCustomHylianShieldOnBackDL);
    PatchOrUnpatch(gLinkAdultHylianShieldAndSheathNearDL, gCustomMasterSwordSheathDL, "customHylianShieldSheath1",
                   "customHylianShieldSheath2", "customHylianShieldSheath3", gCustomHylianShieldOnBackDL);
    PatchOrUnpatch(gLinkAdultMirrorShieldSwordAndSheathNearDL, gCustomMasterSwordInSheathDL, "customMirrorShieldSword1",
                   "customMirrorShieldSword2", "customMirrorShieldSword3", gCustomMirrorShieldOnBackDL);
}
...
static void ApplyBiggoronSwordPatches() {
    ...
    PatchOrUnpatch(gLinkChildHylianShieldAndSheathNearDL, gCustomLongswordSheathDL, "customChildHylianShieldSheath1",
                   "customChildHylianShieldSheath2", "customChildHylianShieldSheath3",
                   gCustomHylianShieldOnChildBackDL);
    ...
    PatchOrUnpatch(gLinkChildHylianShieldSwordAndSheathNearDL, gCustomLongswordInSheathDL,
                   "customChildHylianShieldSword1", "customChildHylianShieldSword2", "customChildHylianShieldSword3",
                   gCustomHylianShieldOnChildBackDL);
    PatchOrUnpatch(gLinkAdultSheathNearDL, gCustomLongswordSheathDL, "customSheath1", "customSheath2", nullptr,
                   nullptr);
    PatchOrUnpatch(gLinkAdultHylianShieldSwordAndSheathNearDL, gCustomLongswordInSheathDL, "customHylianShieldSword1",
                   "customHylianShieldSword2", "customHylianShieldSword3", gCustomHylianShieldOnBackDL);
    PatchOrUnpatch(gLinkAdultHylianShieldAndSheathNearDL, gCustomLongswordSheathDL, "customHylianShieldSheath1",
                   "customHylianShieldSheath2", "customHylianShieldSheath3", gCustomHylianShieldOnBackDL);
    PatchOrUnpatch(gLinkAdultMirrorShieldSwordAndSheathNearDL, gCustomLongswordInSheathDL, "customMirrorShieldSword1",
                   "customMirrorShieldSword2", "customMirrorShieldSword3", gCustomMirrorShieldOnBackDL);
...
static void ApplyBreakableLongswordPatches() {
    ...
    PatchOrUnpatch(gLinkChildHylianShieldAndSheathNearDL, gCustomBreakableLongswordSheathDL,
                   "customChildHylianShieldSheath1", "customChildHylianShieldSheath2", "customChildHylianShieldSheath3",
                   gCustomHylianShieldOnChildBackDL);
    PatchOrUnpatch(gLinkChildDekuShieldAndSheathNearDL, gCustomBreakableLongswordSheathDL, "customDekuShieldSheath1",
                   "customDekuShieldSheath2", "customDekuShieldSheath3", gCustomDekuShieldOnBackDL);
    ...
    PatchOrUnpatch(gLinkAdultMasterSwordAndSheathNearDL, gCustomBreakableLongswordInSheathDL,
                   "customMasterSwordSheath1", "customMasterSwordSheath2", nullptr, nullptr);
    PatchOrUnpatch(gLinkChildSheathNearDL, gCustomBreakableLongswordSheathDL, "customKokiriSheath1",
                   "customKokiriSheath2", nullptr, nullptr);
    ...
    PatchOrUnpatch(gLinkChildHylianShieldSwordAndSheathNearDL, gCustomBreakableLongswordInSheathDL,
                   "customChildHylianShieldSword1", "customChildHylianShieldSword2", "customChildHylianShieldSword3",
                   gCustomHylianShieldOnChildBackDL);
    PatchOrUnpatch(gLinkAdultSheathNearDL, gCustomBreakableLongswordSheathDL, "customSheath1", "customSheath2", nullptr,
                   nullptr);
...
static void ApplyBrokenKnifePatches() {
    ...
    PatchOrUnpatch(gLinkChildDekuShieldAndSheathNearDL, gCustomBrokenLongswordSheathDL, "customDekuShieldSheath1",
                   "customDekuShieldSheath2", "customDekuShieldSheath3", gCustomDekuShieldOnBackDL);
    PatchOrUnpatch(gLinkAdultMasterSwordAndSheathNearDL, gCustomBrokenLongswordInSheathDL, "customMasterSwordSheath1",
                   "customMasterSwordSheath2", nullptr, nullptr);
    PatchOrUnpatch(gLinkChildSheathNearDL, gCustomBrokenLongswordSheathDL, "customKokiriSheath1", "customKokiriSheath2",
                   nullptr, nullptr);
    PatchOrUnpatch(gLinkChildSwordAndSheathNearDL, gCustomBrokenLongswordInSheathDL, "customKokiriSwordSheath1",
                   "customKokiriSwordSheath2", nullptr, nullptr);
    PatchOrUnpatch(gLinkChildDekuShieldSwordAndSheathNearDL, gCustomBrokenLongswordInSheathDL, "customDekuShieldSword1",
                   "customDekuShieldSword2", "customDekuShieldSword3", gCustomDekuShieldOnBackDL);
    PatchOrUnpatch(gLinkChildHylianShieldSwordAndSheathNearDL, gCustomBrokenLongswordInSheathDL,
                   "customChildHylianShieldSword1", "customChildHylianShieldSword2", "customChildHylianShieldSword3",
                   gCustomHylianShieldOnChildBackDL);
    PatchOrUnpatch(gLinkAdultSheathNearDL, gCustomBrokenLongswordSheathDL, "customSheath1", "customSheath2", nullptr,
                   nullptr);
    PatchOrUnpatch(gLinkAdultHylianShieldSwordAndSheathNearDL, gCustomBrokenLongswordInSheathDL,
                   "customHylianShieldSword1", "customHylianShieldSword2", "customHylianShieldSword3",
                   gCustomHylianShieldOnBackDL);
    PatchOrUnpatch(gLinkAdultHylianShieldAndSheathNearDL, gCustomBrokenLongswordSheathDL, "customHylianShieldSheath1",
                   "customHylianShieldSheath2", "customHylianShieldSheath3", gCustomHylianShieldOnBackDL);
    PatchOrUnpatch(gLinkAdultMirrorShieldSwordAndSheathNearDL, gCustomBrokenLongswordInSheathDL,
                   "customMirrorShieldSword1", "customMirrorShieldSword2", "customMirrorShieldSword3",
                   gCustomMirrorShieldOnBackDL);
    PatchOrUnpatch(gLinkAdultMirrorShieldAndSheathNearDL, gCustomBrokenLongswordSheathDL, "customMirrorShieldSheath1",
                   "customMirrorShieldSheath2", "customMirrorShieldSheath3", gCustomMirrorShieldOnBackDL);
}
...
static void ApplyCommonEquipmentPatches() {
    ...
    PatchOrUnpatch(gLinkAdultHookshotTipDL, gCustomHookshotTipDL, "customHookshotTip1", "customHookshotTip2", nullptr,
                   nullptr);
    ...
    if (LINK_IS_CHILD && equipmentAlwaysVisible) {
        PatchOrUnpatch(gCustomAdultFPSHandDL, gCustomChildFPSHandDL, "patchChildFPSHand1", "patchChildFPSHand2",
                       nullptr, nullptr);
        ...
        PatchOrUnpatch(gLinkAdultLeftHandClosedNearDL, gLinkChildLeftFistNearDL, "customChildLeftHand1",
                       "customChildLeftHand2", nullptr, nullptr);
    }

    if (LINK_IS_ADULT && equipmentAlwaysVisible) {
        PatchOrUnpatch(gCustomChildFPSHandDL, gCustomAdultFPSHandDL, "patchAdultFPSHand1", "patchAdultFPSHand2",
                       nullptr, nullptr);
        ...
        PatchOrUnpatch(gLinkChildLeftFistNearDL, gLinkAdultLeftHandClosedNearDL, "customAdultLeftHand1",
                       "customAdultLeftHand2", nullptr, nullptr);
    }
}
